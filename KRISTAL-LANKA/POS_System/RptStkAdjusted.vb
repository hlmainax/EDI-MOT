...
Public Class RptStkAdjusted
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_System.RptStkAdjusted.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xShort() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xAcce() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptStkAdjusted
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStkAdjusted = New RptStkAdjusted()
        rpt.Site = Me.Site
        Return rpt
    End Function
